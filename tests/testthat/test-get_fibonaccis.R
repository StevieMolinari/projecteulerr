...
# test_that("`get_fibonaccis_up_to` has valid `upTo` argument", {
#     expect_error(get_fibonaccis_up_to(upTo = "abc"))
#     expect_error(get_fibonaccis_up_to(upTo = -2))
# })
#
# test_that("`get_fibonaccis_up_to` returns correct sequence", {
#     expect_identical(get_fibonaccis_up_to(upTo = 0), numeric(0))
#     # expect_identical(get_fibonaccis_up_to(upTo = 1/2), numeric(0))
#     expect_identical(get_fibonaccis_up_to(upTo = 1), c(1L, 1L))
#     # expect_identical(get_fibonaccis_up_to(upTo = 3/2), c(1L, 1L))
#     expect_identical(get_fibonaccis_up_to(upTo = 2), c(1L, 1L, 2L))
#     expect_identical(get_fibonaccis_up_to(upTo = 3), c(1L, 1L, 2L, 3L))
#     expect_identical(get_fibonaccis_up_to(upTo = 4), c(1L, 1L, 2L, 3L))
#     expect_identical(get_fibonaccis_up_to(upTo = 5), c(1L, 1L, 2L, 3L, 5L))
#     expect_identical(
#         get_fibonaccis_up_to(upTo = 100),
